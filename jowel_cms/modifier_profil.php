...
if(isset($_GET['modifier_compte']) AND isset($_SESSION['id_utilisateur']) AND $_GET['modifier_compte'] == $_SESSION['id_utilisateur']){
    ...
    if(isset($_POST['modif_profil'])){
        ...
        if($result){
            ...
            $requete1= $bdd->prepare('UPDATE webcms.utilisateurs SET nom_utilisateur =:nom, prenom_utilisateur=:prenom, username=:username, photo_utilisateur=:photo_profil WHERE id_utilisateur=:id_utilisateur');
